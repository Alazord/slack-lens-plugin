...
;this.__t = {
  ...
  dmParticipantKey: (typeof dmParticipantKey==='function'?dmParticipantKey:undefined),
  dedupeDmConversations: (typeof dedupeDmConversations==='function'?dedupeDmConversations:undefined),
